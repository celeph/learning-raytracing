...
//...
  ...
  color: function(r) {
//...
    var t = this.hit_sphere(new vec3(0,0,-1), 0.5, r);
    if (t > 0) {
      var N = r.point_at_parameter(t).sub(new vec3(0,0,-1)).unit_vector();
      return (new vec3(N.x + 1.0, N.y + 1.0, N.z + 1.0)).mul(0.5);
    }
//...
