...
class ray {
  ...
  point_at_parameter(t) { return this.A.add(this.B.mul(t)); }
}
...
//...
  color: function(r, world) {
    ...
    if (world.hit(r, 0.0, Infinity, rec)) {
      return (new vec3(rec.normal.x+1, rec.normal.y+1, rec.normal.z+1)).mul(0.5);
    }
    else {
//...
