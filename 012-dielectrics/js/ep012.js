...
class camera {
  constructor() {
    this.vec3_lower_left_corner = new vec3(-2.0, -1.0, -1.0);
    this.vec3_horizontal = new vec3(4.0, 0.0, 0.0);
    this.vec3_vertical = new vec3(0.0, 2.0, 0.0);
  ...
  getObjectList: function() {
    var list = [
      ...
      */
      ...
      new sphere(new vec3(-1,0,-1), -0.45, new dielectric(1.5)) // inner left glass sphere
    ];
    return list;
  },
