...
class camera {
  constructor(float_vfov, float_aspect) {
...
var ep013 = {
  ...
  renderSinglePass: function() {
    ...
    this.raytracer = new raytracer({
      ...
      camera: new camera(90, this.width/this.height),
//      camera: new camera(45, this.width/this.height),
//      camera: new camera(135, this.width/this.height),
//      camera: new camera(180, this.width/this.height),
